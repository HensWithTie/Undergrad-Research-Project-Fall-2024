...
stime = time.time()
with open("Gen1.txt", "r", encoding="utf-8") as f:
    doc_text = f.read()
...
stime = time.time()
question1 = "Give me 5 moves charizard can learn" #Change question to user input
...
stime = time.time()
question2 = "What does meowth evolve into?" #Change question to user input
clean_up(ronan_cache, origin_len)
...
stime = time.time()
question3 = "Give me the hp, def, and atk of meowth." #Change question to user input
clean_up(ronan_cache, origin_len)
...
stime = time.time()
question4 = "What is the name of entry number 54?" #Change question to user input
clean_up(ronan_cache, origin_len)
